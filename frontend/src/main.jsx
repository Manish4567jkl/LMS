...
import StudentProfile from "./pages/StudentProfile.jsx"; // Fixed import
...
import TrackAllStudents from "./pages/TrackAllStudents.jsx";
  ...
  <StrictMode>
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/getStudentDetails/:studentId" element={<StudentProfile />} /> {/* Fixed route */}
